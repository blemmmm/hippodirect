  ...
  return (
    <nav className="container mx-auto px-6 py-2">
      <ul className="flex flex-row justify-end">
        <li><button onClick={prev_page} className="mx-1 h-10 px-5 text-indigo-600 transition-colors duration-150 rounded-l bg-indigo-100 focus:shadow-outline hover:bg-indigo-200">
        ...
        <li><button onClick={next_page} className="mx-1 h-10 px-5 text-indigo-600 transition-colors duration-150 rounded-r bg-indigo-100 focus:shadow-outline hover:bg-indigo-200">
...
export default Index_Pagination;
